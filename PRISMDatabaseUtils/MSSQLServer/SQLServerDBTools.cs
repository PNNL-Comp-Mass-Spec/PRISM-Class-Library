...
namespace PRISMDatabaseUtils.MSSQLServer
{
    ...
    internal class SQLServerDBTools : DBToolsBase, IDBTools
    {
        ...
        /// <remarks>
        /// This method is typically only used for PostgreSQL commands, but is included here since <see cref="IDBTools"/> requires it
        /// </remarks>
            ...
            ParameterDirection direction = ParameterDirection.Input)
        {
            ...
            switch (dbType)
            {
                case NpgsqlTypes.NpgsqlDbType.Integer:
                    newDbType = SqlType.Int;
                    break;

                case NpgsqlTypes.NpgsqlDbType.Bigint:
                    newDbType = SqlType.BigInt;
                    break;

                case NpgsqlTypes.NpgsqlDbType.Real:
                    newDbType = SqlType.Real;
                    break;

                case NpgsqlTypes.NpgsqlDbType.Double:
                case NpgsqlTypes.NpgsqlDbType.Numeric:
                case NpgsqlTypes.NpgsqlDbType.Money:
                    newDbType = SqlType.Float;
                    break;

                case NpgsqlTypes.NpgsqlDbType.Boolean:
                    newDbType = SqlType.TinyInt;
                    break;

                case NpgsqlTypes.NpgsqlDbType.Smallint:
                    newDbType = SqlType.SmallInt;
                    break;

                case NpgsqlTypes.NpgsqlDbType.Char:
                    newDbType = SqlType.Char;
                    break;

                case NpgsqlTypes.NpgsqlDbType.Varchar:
                    newDbType = SqlType.VarChar;
                    break;

                case NpgsqlTypes.NpgsqlDbType.Text:
                case NpgsqlTypes.NpgsqlDbType.Citext:
                case NpgsqlTypes.NpgsqlDbType.Name:
                    newDbType = SqlType.Text;
                    break;

                case NpgsqlTypes.NpgsqlDbType.Date:
                    newDbType = SqlType.Date;
                    break;

                case NpgsqlTypes.NpgsqlDbType.Timestamp:
                case NpgsqlTypes.NpgsqlDbType.TimestampTz:
                    newDbType = SqlType.DateTime;
                    break;

                case NpgsqlTypes.NpgsqlDbType.Xml:
                    newDbType = SqlType.Xml;
                    break;

                default:
                    throw new NotSupportedException(string.Format(
                        "Cannot convert NpgsqlTypes.NpgsqlDbType enum {0} to SqlType", dbType.ToString()));
            }

            return AddParameter(command, name, newDbType, size, direction);
        }
