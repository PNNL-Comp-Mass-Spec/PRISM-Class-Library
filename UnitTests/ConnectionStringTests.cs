...
namespace PRISMTest
{
    ...
    internal class ConnectionStringTests
    {
        ...
        [TestCase(DbServerTypes.PostgreSQL, "Host=prismdb2;Username=d3l243;Password=SecretKey;Database=dms", "", "Host=prismdb2;Username=d3l243;Password=SecretKey;Database=dms")]
        [TestCase(DbServerTypes.PostgreSQL, "Host=prismdb2;Username=d3l243;Password=SecretKey;Database=dms", "PRISMTest", "Host=prismdb2;Username=d3l243;Password=SecretKey;Database=dms;Application Name=PRISMTest")]
        [TestCase(DbServerTypes.PostgreSQL, "Host=prismdb2;Username=d3l243;Password=SecretKey", "", "Host=prismdb2;Username=d3l243;Password=SecretKey")]
        [TestCase(DbServerTypes.PostgreSQL, "Host=prismdb2;Username=d3l243;Password=SecretKey", "PRISMTest", "Host=prismdb2;Username=d3l243;Password=SecretKey;Application Name=PRISMTest")]
        [TestCase(DbServerTypes.PostgreSQL, "Host=prismdb2;Username=d3l243;Password=SecretKey;", "PRISMTest", "Host=prismdb2;Username=d3l243;Password=SecretKey;Application Name=PRISMTest")]
        ...
        [TestCase(DbServerTypes.PostgreSQL, "Host=prismdb2;Username=d3l243", "", "Host=prismdb2;Username=d3l243", true)]
        [TestCase(DbServerTypes.PostgreSQL, "Host=prismdb2;UserId=d3l243",   "", "Host=prismdb2;UserId=d3l243", true)]
        [TestCase(DbServerTypes.PostgreSQL, "Host=prismdb2;Username=d3l243", "PRISMTest", "Host=prismdb2;Username=d3l243;Application Name=PRISMTest", true, 2)]
        [TestCase(DbServerTypes.PostgreSQL, "Host=prismdb2;UserId=d3l243",   "PRISMTest", "Host=prismdb2;Username=d3l243;Application Name=PRISMTest", true, 2)]
        [TestCase(DbServerTypes.PostgreSQL, "Host=prismdb2;Username=d3l243;Database=dms;", "", "Host=prismdb2;Username=d3l243;Database=dms;", true, 2)]
        [TestCase(DbServerTypes.PostgreSQL, "Host=prismdb2;Username=d3l243;Database=dms;", "PRISMTest", "Host=prismdb2;Username=d3l243;Database=dms;Application Name=PRISMTest", true, 2)]
        [Category("PNL_Domain")]
        ...
        [TestCase(DbServerTypes.PostgreSQL, "Host=prismdb2;Username=d3l243;Password=SecretKey;Database=dms", "")]
        [TestCase(DbServerTypes.PostgreSQL, "Host=prismdb2;Username=d3l243;Password=SecretKey;Database=dms", "PRISMTest")]
        [TestCase(DbServerTypes.PostgreSQL, "Host=prismdb2;Username=d3l243;Password=SecretKey", "")]
        [TestCase(DbServerTypes.PostgreSQL, "Host=prismdb2;Username=d3l243;Password=SecretKey", "PRISMTest")]
        [TestCase(DbServerTypes.PostgreSQL, "Host=prismdb2;Username=d3l243;Password=SecretKey;", "PRISMTest")]
        ...
        [TestCase(DbServerTypes.PostgreSQL, "prismdb2", "", "", "", null, "", "Host=prismdb2")]
