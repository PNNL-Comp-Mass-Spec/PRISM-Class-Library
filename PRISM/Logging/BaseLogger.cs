...
namespace PRISM.Logging
{
    ...
    public abstract class BaseLogger
    {
        ...
        /// </summary>
        // ReSharper disable once UnusedMember.Global
        public static string ExecutableVersion => mProgramVersion ??= AppUtils.GetEntryOrExecutingAssembly().GetName().Version.ToString();

        /// <summary>
        /// Gets the name of the executable file that started the application
        /// </summary>
        public static string ExecutableName => mProgramName ??= Path.GetFileName(AppUtils.GetEntryOrExecutingAssembly().Location);
